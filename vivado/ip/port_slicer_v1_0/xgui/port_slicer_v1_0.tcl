...
proc init_gui { IPINST } {
  ...
  set DIN_FROM [ipgui::add_param $IPINST -name "DIN_FROM" -parent ${Page_0}]
  set_property tooltip {Index of the highest selected bit.} ${DIN_FROM}
  set DIN_TO [ipgui::add_param $IPINST -name "DIN_TO" -parent ${Page_0}]
  set_property tooltip {Index of the lowest selected bit.} ${DIN_TO}
  set DIN_WIDTH [ipgui::add_param $IPINST -name "DIN_WIDTH" -parent ${Page_0}]
  set_property tooltip {Width of the input port.} ${DIN_WIDTH}
